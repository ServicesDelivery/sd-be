...
public class CompanyRecord extends UpdatableRecordImpl<CompanyRecord> implements Record5<Integer, String, String, Integer, Double> {
    ...
    @Override
    public CompanyRecord values(Integer value1, String value2, String value3, Integer value4, Double value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CompanyRecord(Integer id, String name, String description, Integer price, Double rating) {
        super(Company.COMPANY);
